        ...
        >
          <table class="w-full text-left border-collapse">
            <thead class="bg-gray-50 border-b border-gray-200">
              <tr>
                <th class="p-4 text-xs font-bold text-gray-500 uppercase">
                  Sản phẩm
                </th>
                <th class="p-4 text-xs font-bold text-gray-500 uppercase">
                  Loại
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                  ...
                  <div class="flex items-center">
                    <div class="relative h-14 w-14 shrink-0">
                      <img
                        ...
                        class="h-full w-full rounded-md object-cover border border-gray-100 shadow-sm"
                        alt=""
                      />
                      <span
                        v-if="parseJson(product.images_sub).length > 0"
                        class="absolute -top-2 -right-2 bg-blue-500 text-white text-[10px] px-1.5 py-0.5 rounded-full border border-white"
                      >
                ...
                <td class="p-4 text-sm text-gray-600">
                  <span
                    class="px-2 py-1 bg-gray-100 rounded-full text-[11px] font-semibold"
                    >{{ product.category }}</span
                  >
                </td>

                <td
                  class="p-4 text-sm font-mono font-bold text-right text-indigo-600"
                >
                  {{
